...
const Cart = () => {
  const { products, currency, cartItems, updateQuantity, getUserCart } = useContext(ShopContext);
  ...
  return (
    <div className="border-t pt-14">
      <div className="flex flex-col items-center text-3xl mb-3">
        {cartData.length === 0 ? (
          <>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-8">
              ...
              <button
                ...
                className="bg-gray-200 text-black px-6 py-3 text-sm hover:bg-gray-300 transition"
              >
                Already have Orders
              </button>
            </div>
